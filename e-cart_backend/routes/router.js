...
router.delete("/carts/delete-cart-product/:id", cartController.deleteCart);
router.get(
  "/carts/increment-cart-product/:id",
  cartController.incrementCartCount
);
router.get(
  "/carts/decrement-cart-product/:id",
  cartController.decrementCartCount
);
